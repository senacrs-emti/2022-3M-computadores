...
<br>
  ...
  <label class="btn btn-secondary active">
    <input type="radio" name="CPU" id="CPU" value="intel" autocomplete="off"> Intel
  </label>
  <label class="btn btn-secondary">
    <input type="radio" name="CPU" id="CPU" value="amd" autocomplete="off"> AMD
  </label>
</div>
...
<br>
    ...
    <div class="btn-group btn-group-toggle" data-toggle="buttons">
  <label class="btn btn-secondary active">
    <input type="radio" name="preco" id="preco" value="4" autocomplete="off"> 4mil
  </label>
  <label class="btn btn-secondary">
    <input type="radio" name="preco" id="preco" value="6" autocomplete="off"> 6mil
  </label>
  <label class="btn btn-secondary active">
    <input type="radio" name="preco" id="preco" value="8" autocomplete="off"> 8mil
  </label>
  <label class="btn btn-secondary">
